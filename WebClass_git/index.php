   ...
   <section id="tentang">
        ...
        <div class="glass-card">
            <div class="tentang-content">
                <div class="tentang-text">
                    ...
                    <p>Kelas Anomali adalah kelas di Program Studi Teknik Informatika Universitas Jenderal Achmad Yani yang berdiri sejak tahun 2024. Kami dikenal sebagai kelas dengan kreativitas tinggi dan kemampuan problem solving yang luar biasa.</p>
                    <p>Nama "Anomali" dipilih karena kami percaya bahwa setiap mahasiswa memiliki keunikan dan kemampuan khusus yang membuat mereka berbeda dari yang lain. Kami bukan kelas biasa, kami adalah kelas dengan karakter yang kuat dan kemampuan untuk membuat perubahan.</p>
                    <p>Di Kelas Anomali, kami tidak hanya belajar tentang koding dan teknologi, tetapi juga tentang kolaborasi, kepemimpinan, dan inovasi. Kami percaya bahwa teknologi harus digunakan untuk menciptakan solusi yang bermanfaat bagi masyarakat.</p>
                </div>
        ...
        <div class="container">
           ...
           <div class="gallery-grid">
            ...
            <div class="gallery-item" data-category="Random">
                ...
                <div class="overlay">
                    <h3>Buka bersama ramadahan 2024</h3>
    ...
    <section id="mahasiswa">
        <div class="container">
            ...
            <div class="students-grid" id="studentsContainer">
                <!-- Kartu mahasiswa akan diisi oleh JavaScript -->
            </div>
            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    <div class="timeline-content">
                        ...
                        <h3 class="timeline-title">Website kelas Anomali</h3>
                        <p class="timeline-desc">Platform yang berisikan informasi mengenai para mahasiswa kelas C prodi informatika unjani</p>
                        <div class="tech-tags">
                ...
                <div class="timeline-item">
                    <div class="timeline-content">
                        <span class="timeline-date">Juni 2025</span>
                        <h3 class="timeline-title">Tugas besar Pemrograman Website</h3>
                        <p class="timeline-desc">Tugas berupa website dari matakuliah Pemrograman website</p>
                        <div class="tech-tags">
                            <span class="tech-tag">Html5</span>
                            <span class="tech-tag">Css</span>
                            <span class="tech-tag">JavaScript</span>
        ...
        <div class="container">
            ...
            <div class="social-container">
                <div class="social-card">
                    ...
                    <a href="https://www.instagram.com/ifclass_anomali?igsh=MXNwcTZrNnRoamRsZw==" class="social-link">Follow @ifclass_anomali</a>
                </div>
                ...
                <div class="social-card">
                    ...
                    <h3>YouTube</h3>
                    <p>Subscribe channel kami untuk tutorial pemrograman, rekaman seminar, dan video proyek mahasiswa.</p>
                ...
                <div class="social-card">
                    ...
                    <h3>GitHub</h3>
                    <p>Kunjungi repositori kami untuk melihat kode sumber proyek open source yang dikembangkan mahasiswa.</p>
    ...
    <section id="forum">
        <div class="comment-form glass-card">
            <h3 style="text-align: center; color: white; margin-bottom: 20px;">Tambah Komentar</h3>
            <form method="POST" action="simpan_komentar.php">
                ...
                <div class="form-group">
                    ...
                    <textarea id="comment" name="komentar" class="form-control" rows="5" placeholder="Tulis komentar Anda..." required></textarea>
                </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-about">
                    ...
                    <p>Kelas khusus Program Studi Teknik Informatika Universitas Jenderal Achmad Yani yang fokus pada pengembangan talenta digital dan inovasi teknologi.</p>
